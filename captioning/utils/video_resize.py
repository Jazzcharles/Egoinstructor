### Refer to EgoVLP: https://github.com/showlab/EgoVLP ###
...
def videos_resize(videoinfos):
    ...
    cmd = "ffmpeg -y -i {} -filter:v scale=\"trunc(oh*a/2)*2:320\" -c:a copy {}".format( inname, outname)
